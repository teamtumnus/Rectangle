...
public final class ShortcutBinder {
    ...
    static let unsupportedPreferencesBackupKey = "HardRectangleShortcuts.unsupportedShortcutPreferences"
        ...
        for (key, shortcut) in shortcuts {
            if let storedValue = userDefaults.object(forKey: key),
               ...
               Self.shortcut(from: storedValue) == nil {
                ...
                // outside the active key lets HardRectangle expose its current default.
