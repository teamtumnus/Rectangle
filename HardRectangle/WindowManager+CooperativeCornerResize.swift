...
extension WindowManager {
    ...
    func cooperativeCornerResizePlan(focusedWindowId: CGWindowID?,
                                     ...
                                     lastHardRectangleAction: HardRectangleAction?) -> CooperativeCornerApplicationPlan? {
        ...
        let isRepeatedCooperativeAction = action.isCompatibleRepeatedResizeAction(with: lastHardRectangleAction?.action)
    ...
    func applyCooperativeCornerCleanupIfNeeded(focusedWindowId: CGWindowID?,
                                               ...
                                               lastHardRectangleAction: HardRectangleAction?) {
        guard Defaults.cooperativeCornerResize.enabled,
              source.allowsCooperativeResize,
              let previousAction = lastHardRectangleAction?.action,
        ...
        guard let targetFrame = cleanupTargetFrame(action: previousAction,
                                                   ...
                                                   movedEdge: movedEdge,
                                                   tolerance: tolerance,
                                                   includeCycleTargets: (lastHardRectangleAction?.count ?? 0) > 1,
