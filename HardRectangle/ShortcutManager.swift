...
struct HardRectangleShortcutBindingStore: ShortcutBindingStore {
    func configure() {}
...
class ShortcutManager {
    ...
    init(
        ...
        bindingStore: ShortcutBindingStore = HardRectangleShortcutBindingStore(),
    ...
    private func executeCycle(_ group: ShortcutCycle.Group) {
        ...
        let lastAction = AppDelegate.windowHistory.lastHardRectangleActions[windowId]
        ...
        let selectedAction = ShortcutCycle.action(
            in: group,
            lastAction: AppDelegate.windowHistory.lastHardRectangleActions[windowId],
    ...
    private func isRepeatAction(parameters: ExecutionParameters, windowElement: AccessibilityElement, windowId: CGWindowID) -> Bool {
        ...
        if parameters.action == AppDelegate.windowHistory.lastHardRectangleActions[windowId]?.action {
            return true
        }
        return false
    }
...
struct ShortcutCycle {
    ...
    static func action(in group: Group, lastAction: HardRectangleAction?, currentWindowRect: CGRect?) -> WindowAction {
    ...
    static func isStale(lastAction: HardRectangleAction?, currentWindowRect: CGRect?) -> Bool {
