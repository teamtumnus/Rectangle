...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func checkLaunchOnLogin() {
        let enabled = LaunchOnLoginPreferenceResolver().resolve {
            ...
            alert.messageText = "Launch Rectangle when you log in?".localized
            alert.informativeText = "Rectangle can start automatically after you sign in. You can change this at any time in Settings.".localized
